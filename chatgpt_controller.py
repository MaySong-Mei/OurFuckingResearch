...
def call_chatgpt_for_patches(
    ...
    user_prompt = f"Analyze this medical image and identify which patches contain {prompt}. Return the positive and negative patch sequences as JSON. Limit your positive points and negative points to a maximum of 5 points and make sure to mark non-targets around the target object."
